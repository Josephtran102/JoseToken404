...
async function main() {
    ...
    const token0 = '0xE6049C49A2583ED10C00954668FA407874016128' // JOSE404 Token Address on Sepolia
    ...
    const my404Contract = await ethers.getContractAt('JOSE404', token0, deployer)
